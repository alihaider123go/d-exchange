    ...
    return (
        <div className="banner" id="home" style={{backgroundImage:'url("assets/img/banner-bg.png")'}}>
            <div className="illustration">
                <img src="assets/img/banner-bg-1.png" alt="banner-bg-1" className="one" />
                <img src="assets/img/banner-bg-2.png" alt="banner-bg-2" className="two" />
                <img src="assets/img/banner-map.png" alt="banner-map" className="three" />
            </div>
                    ...
                    <div className="row align-items-center justify-content-between">
                        <div className="col-xl-7 col-lg-6">
                            <div className="banner-content wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                                <h3 className="subtitle">Fast & Convenient</h3>
                                <h1 className="head">Cryptocurrency Exchange</h1>
                                <p className="text">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, quisquam. </p>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 wow fadeInRightBig" data-wow-duration="0.3s" data-wow-delay="0.5s">
                            <div className="exchange">
                                ...
                                <div className="exchange-box">
                                    ...
                                    <div>
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" placeholder={token_1?.symbol || "Select"} onChange={(e)=>setInputAmount(e.target.value)}/>
                                        </div>
                                    </div>
                                ...
                                <a className="rotate">
                                    <img src="assets/img/exchange-img.png" alt="exchange-rotate-icon" onClick={()=>reset()}/>
                                </a>
                                <div className="exchange-box">
                                    <div className="selector">
                                        <p className="text">
