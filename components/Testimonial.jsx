                ...
                <div className="row justify-content-center">
                    <div className="col-lg-5 text-center wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
                        <div className="section-head">
                            ...
                            <h2 className="title">Don't just take out word for it!</h2>
                            <p className="text">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur deserunt ipsam sed dolore voluptas a dolorum qui eum corporis aspernatur.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-lg-12 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.5s">
                        <div className="about-testimonial">
                            <img src="assets/img/world-map.png" alt="world-map.png" />
                                    ...
                                    <div id="myPopover" className="popover popover-default mypopover">
                                        <div className="client-review">
                                            ...
                                            <div className="client-info">
                                                <h4 className="name">Ali Haider</h4>
