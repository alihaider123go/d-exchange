...
const { Pool,nearestUsableTick,TickMath,TICK_SPACINGS, FeeAmount, Trade: V3Trade, Route: V3Route} = require("@uniswap/v3-sdk");

const { MixedRouteTrade, Trade: RouterTrade, RouteV2, RouteV3 } = require("@uniswap/router-sdk");
...
const usdcContract = new hardhat.ethers.Contract(
    ...
    async function getPool(tokenA,tokenB,feeAmount,provider){
        ...
        const contract = new hardhat.ethers.Contract(poolAddress,IUniswapV3Pool,provider);
